...
export function SessionsPage({userId,isHealer,onClose}:{userId:string;isHealer:boolean;onClose:()=>void}) {
  ...
  const load=useCallback(async()=>{
    ...
    const [{data,error},{data:registrations,error:regError}]=await Promise.all([
